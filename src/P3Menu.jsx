...
export default function P3Menu({ onNavigate }) {
  ...
  const activate = (idx) => {
    setActive(idx);
    setAnimKey(k => k + 1); // This retriggers the "pop" animation
  };
  ...
  return (
    <>
      <style>{`
        /* Note: Make sure 'Anton' is imported in index.css, or add an @import here if needed */
        .p3-overlay {
          position: absolute;
          inset: 0;
          z-index: 10;
        ...
        .p3-menu {
          ...
          align-items: center; /* This centers the menu items! */
          pointer-events: all;
        }
      ...
      <div className="p3-overlay">
        ...
        <nav className="p3-menu">
          {ITEMS.map((item, i) => {
            ...
            // Reverted the sizing math to the original logic
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {/* The layered text for the dark/bright transition effect */}
